...
const VendorProductPricing = () => {
  ...
  useEffect(() => {
    const fetchMenuItems = async () => {
      ...
      try {
        const response = await axios.get("http://localhost:4000/api/getMenuItems", {
        ...
        const pricingResponse = await axios.get("http://localhost:4000/api/getProductPricing", {
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:4000/api/addProductPricing",
        {
          vendorId: selectedVendor,
          restaurantId: selectedRestaurant,
